...
if ENV["COVERAGE"] == "true"
  ...
  # Configure SimpleCov for parallel testing if PARALLEL_COVERAGE is set
  SimpleCov.command_name Process.pid.to_s if ENV["PARALLEL_COVERAGE"] == "true"
  ...
  SimpleCov.start "rails" do
    ...
    # Output formats - don't include Cobertura in parallel mode as it can cause issues
