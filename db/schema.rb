...
ActiveRecord::Schema[8.1].define(version: 2026_07_29_120000) do
  ...
  create_table "backtest_runs", force: :cascade do |t|
    ...
    t.jsonb "metrics"
    t.decimal "per_contract_fee", precision: 12, scale: 6
  ...
  create_table "contracts", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "deep_1m_backfilled_at"
    ...
    t.datetime "updated_at", null: false
    t.index ["deep_1m_backfilled_at"], name: "index_contracts_awaiting_deep_1m_backfill", where: "(deep_1m_backfilled_at IS NULL)"
